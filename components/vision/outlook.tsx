        ...
        <section className="section-padding bg-background px-4 py-24">
            <div className="container">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold">Industry Outlook</h2>
                    <p className="text-lg text-muted-foreground mt-4 max-w-2xl mx-auto">
                        Key trends shaping the future of financial leadership
                    </p>
                </div>
                ...
                >
                    {visionContent.outlook.map((item, index) => {
