                ...
                <div className="relative aspect-square lg:aspect-auto">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center p-12">
                        <div className="text-center">
                            <div className="text-5xl md:text-7xl font-bold mb-4 text-foreground dark:text-white">20+</div>
                            <p className="text-xl text-muted-foreground dark:text-gray-300">Years of Financial Leadership</p>
                        </div>
                    </div>
                </div>
            </div>
