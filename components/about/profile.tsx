        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center animate-fade-in">
          ...
          <div className="space-y-8 md:col-span-8 order-1 md:order-2 animate-fade-up">
            ...
            <div className="space-y-5 text-lg text-pretty dark:text-gray-300">
              <p className="leading-relaxed">{aboutContent.intro}</p>
              <p className="leading-relaxed">
                ...
                , I&apos;ve guided organizations through periods of growth,
                market volatility, and technological disruption.
              </p>
              <p className="leading-relaxed">
                My approach combines rigorous analysis with strategic foresight,
                always keeping the human impact of financial decisions at the
